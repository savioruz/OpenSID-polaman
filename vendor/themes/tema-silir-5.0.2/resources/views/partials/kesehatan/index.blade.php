...
@section('content')
  ...
  <form class="grid grid-cols-1 lg:grid-cols-4 gap-3 py-3 w-full main-content" action="" method="get">
    <div class="space-y">
    ...
    <div class="space-y">
      <select name="id_posyandu" id="id_posyandu" class="form-input inline-block" title="Pilih salah satu">
    ...
    <div class="col-md-2">
      <button class="button button-secondary" data-mdb-ripple="true" data-md-ripple-color="light"
        id="cari">
