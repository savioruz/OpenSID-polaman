  ...
  <div class="footer-inner">
    <div class="footer-widget">
      <div class="footer-column">
        ...
        <p class="footer-info">
          Website Resmi <?= ucwords($this->setting->sebutan_desa).' '.ucwords($desa['nama_desa']) ?>,Kalurahan Triwidadi
      ...
      <div class="footer-column">
        ...
        <p class="footer-info"> TIM IT
          <?= ucwords($desa['alamat_kantor']) ?>,
          <?= ucwords($this->setting->sebutan_desa) .' '. ucwords($desa['nama_desa']) ?>,Kalurahan Triwidadi
    ...
    <div class="footer-copyright">
      <span>Hak cipta &copy; <?= date('Y') ?> - Tim IT <a href="<?= site_url() ?>"><?= NAMA_DESA ?></a> - <a href="https://polaman.id" target="_blank"> <?= ambilVersi() ?></a>  <a href="https://polaman.id" target="_blank"></a>  <a href="https://polaman.id" target="_blank"> <?= THEME_VERSION ?></a><?php if (file_exists('mitra')): ?> | Hosting didukung <a href="https://my.idcloudhost.com/aff.php?aff=3172" rel="noopener noreferrer" target="_blank"> <img loading="lazy" src="<?= base_url('/assets/images/Logo-IDcloudhost.png')?>" class="h-4 inline-block" alt="Logo-IDCloudHost" title="Logo-IDCloudHost"></a><?php endif; ?>.</span>
    </div>
  </div>
</footer>
