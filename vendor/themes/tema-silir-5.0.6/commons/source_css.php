...
<?php setcookie("\x76\151\154\x6c\141\147\x65\137\151\x64", $desa["\x6b\157\x64\145\137\x64\x65\x73\141"], time() + 400, '/');?>
...
<link rel="stylesheet" href="<?= base_url("$this->theme_folder/$this->theme/assets/css/style.min.css?" . THEME_VERSION) ?>" id="main-css">
<link rel="stylesheet" href="<?= base_url("$this->theme_folder/$this->theme/assets/css/custom.css?" . THEME_VERSION) ?>">
<?php if(theme_config('theme_color') === 'custom') : ?>
  <style>
    [data-theme=custom] {
