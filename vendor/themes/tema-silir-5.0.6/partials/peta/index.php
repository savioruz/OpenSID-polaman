  ...
  <div class="modal-dialog relative w-auto modal-sm">
    <div class="modal-content rounded-lg">
      <div class="flex flex-shrink-0 items-center justify-between p-4 border-b border-gray-200 rounded-t-md dark:border-gray-500">
        ...
        <button type="button" class="w-4 h-4 inline flex items-center justify-center dark:text-white border-none rounded-none opacity-50 focus:shadow-none focus:outline-none focus:opacity-100 hover:opacity-75 hover:no-underline" data-bs-dismiss="modal" aria-label="Tutup"><i class="ti ti-x text-xl"></i></button>
      </div>
...
<div class="modal fade fixed top-0 left-0 hidden w-full h-full outline-none overflow-x-hidden overflow-y-auto" id="modalContent" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
...
<script>
  $(document).ready(function (){
    $('body').on('click', 'a[data-bs-target="#modalContent"]', function(e) {
      ...
      $('#modalContent .modal-title').text(title);
      $('#modalContent .fetched-data').load(href, function() {
    ...
    $('body').on('click', 'a[data-bs-target="#modalKecil"]', function(e) {
      e.preventDefault(); // Prevent default link behavior
      ...
      // Set the modal title and load the content
      $('#modalKecil .modal-title').text(title);
      $('#modalKecil .fetched-data').load(href);
