<div class="py-4 px-5 mx-auto w-full space-y-3">
  <h1 class="text-heading text-lg lg:text-2xl border-b border-dotted border-primary dark:border-white pb-2 title">Struktur Organisasi dan Tata Kerja <?= setting('sebutan_pemerintah_desa') ?></h1>

  <figure class="highcharts-figure py-3" style="max-width: 100%;">
