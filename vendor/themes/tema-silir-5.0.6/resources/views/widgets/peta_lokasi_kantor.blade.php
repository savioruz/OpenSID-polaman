<div class="box box-primary box-solid">
  <div class="box-header">
    <h3 class="box-title">
      <i class="ti ti-map-pin mr-1"></i>{{'Lokasi Kantor ' . ucwords(setting('sebutan_desa')) }}
    </h3>
  </div>
  <div class="box-body space-y-3">
    <div id="map_canvas" style="height:200px;"></div>
    <a class="button button-tertiary block w-full text-center" href="https://www.openstreetmap.org/#map=15/{{$desa['lat'] . '/' . $desa['lng']}}" style="color:#fff;" target="_blank" data-mdb-ripple="true" data-md-ripple-color="light">Buka Peta</a>
