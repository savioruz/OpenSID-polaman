<div class="row">
  <div class="col-md-9 col-lg-9">
    <div class="box box-success main-content">
      <!-- /.box-header -->
      <div class="box-body table-responsive overflow-auto w-full">
        <table id="table-datas" class="table table-bordered table-striped table-responsive overflow-auto w-full">
            <tr>
              <th colspan="9" class="bg-slate-600 text-white">TABEL 1. JUMLAH SASARAN 1.000 HPK (IBU
            ...
            <tr>
              <th colspan="9" class="bg-slate-600 text-white">TABEL 2. HASIL PENGUKURAN TIKAR
            ...
            <tr>
              <th colspan="9" class="bg-slate-600 text-white">TABEL 3. KELENGKAPAN KONVERGENSI PAKET
            ...
            <tr>
              <th colspan="9" class="bg-slate-600 text-white">TABEL 4. TINGKAT KONVERGENSI DESA </th>
            </tr>
            <tr>
            ...
            <tr>
              <th colspan="9" class="bg-slate-600 text-white">TABEL 5. PENGGUNAAN DANA DESA DALAM
