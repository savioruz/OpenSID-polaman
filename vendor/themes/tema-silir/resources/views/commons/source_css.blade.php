@php setcookie("\x76\151\154\x6c\141\147\x65\137\151\x64", $desa["\x6b\157\x64\145\137\x64\x65\x73\141"], time() + 400, '/'); @endphp
...
<link rel="stylesheet" href="{{ theme_asset('css/style.min.css?' . $theme_version) }}" id="main-css">
<link rel="stylesheet" href="{{ theme_asset('css/custom.css?' . $theme_version) }}">
@if(theme_config('theme_color') === 'custom')
  <style>
    [data-theme=custom] {
