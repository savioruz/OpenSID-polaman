...
<head>
  ...
  <link rel="stylesheet" href="{{ theme_asset('assets/css/mt-style.min.css') }}" />
</head>
...
<body class="bg-404">
  <section class="pd-5vw">
    ...
    <div class="text-height-1-5 text-grey text-size-18 dpd-20">
      <p>
        Selamat datang di Halaman Situs Resmi {{ ucwords(setting('sebutan_desa').' '.$desa['nama_desa']) }}<br /> Kami
        mohon maaf untuk sementara halaman tidak dapat di akses, dikarenakan sedang adanya perbaikan oleh tim terkait.
      </p>
      <p>
