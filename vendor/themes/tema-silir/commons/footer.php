...
<footer class="footer">
  <div class="footer-inner">
    ...
    <div class="footer-copyright">
      <span>Hak cipta &copy; <?= date('Y') ?> - Pemerintah <a href="<?= site_url() ?>"><?= NAMA_DESA ?></a> - <a href="https://github.com/OpenSID/OpenSID" target="_blank">OpenSID <?= ambilVersi() ?></a> | <a href="https://opendesa.id" target="_blank">OpenDesa</a> | <a href="https://silirdev.com" target="_blank">Tema Silir <?= THEME_VERSION ?></a><?php if (file_exists('mitra')): ?> | Hosting didukung <a href="https://my.idcloudhost.com/aff.php?aff=3172" rel="noopener noreferrer" target="_blank"> <img loading="lazy" src="<?= base_url('/assets/images/Logo-IDcloudhost.png')?>" class="h-4 inline-block" alt="Logo-IDCloudHost" title="Logo-IDCloudHost"></a><?php endif; ?>.</span>
    </div>
  </div>
</footer>
