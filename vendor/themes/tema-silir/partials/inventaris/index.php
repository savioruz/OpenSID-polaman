<div class="content px-0 py-0">
  <div class="box box-danger"
    <div class="box-header with-border">
      <h1 class="box-title">Inventaris <?= ucwords(setting('sebutan_desa')) ?></h1>
    </div>
      ...
      <table class="table table-striped table-bordered" id="inventaris">
        ...
        <tbody>
          <tr>
            ...
            <td>Informasi mengenai segala yang menyangkut dengan tanah (dalam hal ini tanah yang digunakan dalam
              instansi tersebut).</td>
            <td>
            ...
            <td>
              <div class="btn-group" role="group" aria-label="...">
                <a href="<?= site_url('inventaris/tanah'); ?>" title="Lihat Data" type="button"
          ...
          <tr>
            ...
            <td>
              <div class="btn-group" role="group" aria-label="...">
                <a href="<?= site_url('inventaris/peralatan-dan-mesin'); ?>" title="Lihat Data" type="button"
                  class="btn btn-default btn-sm"><i class="fa fa-eye"></i></a>
              </div>
            </td>
          </tr>
          <tr>
            ...
            <td>
              <div class="btn-group" role="group" aria-label="...">
                <a href="<?= site_url('inventaris/gedung-dan-bangunan'); ?>" title="Lihat Data" type="button"
                  class="btn btn-default btn-sm"><i class="fa fa-eye"></i></a>
              </div>
            </td>
          </tr>
          <tr>
            ...
            <td>
              <div class="btn-group" role="group" aria-label="...">
                <a href="<?= site_url('inventaris/jalan-irigasi-dan-jaringan'); ?>" title="Lihat Data" type="button"
                  class="btn btn-default btn-sm"><i class="fa fa-eye"></i></a>
              </div>
            </td>
          </tr>
          <tr>
            ...
            <td>
              <div class="btn-group" role="group" aria-label="...">
                <a href="<?= site_url('inventaris/asset-tetap-lainnya'); ?>" title="Lihat Data" type="button"
                  class="btn btn-default btn-sm"><i class="fa fa-eye"></i></a>
              </div>
            </td>
          </tr>
          <tr>
            ...
            <td>
              <div class="btn-group" role="group" aria-label="...">
                <a href="<?= site_url('inventaris/konstruksi-dalam-pengerjaan'); ?>" title="Lihat Data" type="button"
                  class="btn btn-default btn-sm"><i class="fa fa-eye"></i></a>
              </div>
            </td>
          </tr>
        ...
        <tfoot>
          <tr>
            ...
            <th>
              <?= $inventaris_tanah_pribadi->total + $inventaris_peralatan_pribadi->total + $inventaris_gedung_pribadi->total + $inventaris_jalan_pribadi->total + $inventaris_asset_pribadi->total + $inventaris_kontruksi_pribadi->total?>
            </th>
            <th>
              <?= $inventaris_tanah_pemerintah->total + $inventaris_peralatan_pemerintah->total + $inventaris_gedung_pemerintah->total + $inventaris_jalan_pemerintah->total + $inventaris_asset_pemerintah->total + $inventaris_kontruksi_pemerintah->total?>
            </th>
            <th>
              <?= $inventaris_tanah_provinsi->total + $inventaris_peralatan_provinsi->total + $inventaris_gedung_provinsi->total + $inventaris_jalan_provinsi->total + $inventaris_asset_provinsi->total + $inventaris_kontruksi_provinsi->total?>
            </th>
            <th>
              <?= $inventaris_tanah_kabupaten->total + $inventaris_peralatan_kabupaten->total + $inventaris_gedung_kabupaten->total + $inventaris_jalan_kabupaten->total + $inventaris_asset_kabupaten->total + $inventaris_kontruksi_kabupaten->total?>
            </th>
            <th>
              <?= $inventaris_tanah_sumbangan->total + $inventaris_peralatan_sumbangan->total + $inventaris_gedung_sumbangan->total + $inventaris_jalan_sumbangan->total + $inventaris_asset_sumbangan->total + $inventaris_kontruksi_sumbangan->total?>
            </th>
            <th></th>
          </tr>
        </tfoot>
