    ...
    <form action="<?= site_url('/add_comment/'.$single_artikel['id'])?>" method="POST" class="space-y-3"  id="kolom-komentar">
      ...
      <div class="flex flex-col lg:flex-row">
        <div class="w-full lg:w-5/12 overflow-hidden">
          ...
          <button type="button" class="button button-transparent text-sm" onclick="document.getElementById('captcha').src = '<?= site_url("captcha") ?>'" data-mdb-ripple="true" data-mdb-ripple-color="light">[Ganti Gambar]</button>
        </div>
